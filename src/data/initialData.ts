...
export const INITIAL_VIDEOS: Video[] = [
  {
    id: 'vid-1',
    title: '🔥 ফেসবুকে তুমুল ভাইরাল হওয়া নতুন মজার ভিডিওটি একবার হলেও দেখুন!',
    description: 'আজকের সবচেয়ে বেশি শেয়ার হওয়া দুর্দান্ত কমেডি ক্লিপ। দেখুন এবং বন্ধুদের সাথে শেয়ার করুন!',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4',
    videoType: 'mp4',
    thumbnail: 'https://images.unsplash.com/photo-1578632767115-351597cf2477?w=800&auto=format&fit=crop&q=80',
    category: '😂 ফানি ভিডিও',
    tags: ['ভাইরাল', 'কমেডি', 'ফান', 'ট্রেন্ডিং'],
    views: 342500,
    likes: 24800,
    shares: 12400,
    duration: '09:56',
    ...
    midrollTime: 7,
    adDuration: 20,
    directDownloadLink: 'https://example.com/download-hd',
    uploaderName: 'ভাইরাল কিং মিডিয়া',
    status: 'published'
  },
  {
    id: 'vid-2',
    title: '💥 ব্রেকিং: এইমাত্র ঘটে যাওয়া তুমুল আলোচিত ঘটনার অবিশ্বাস্য ভিডিও ফুটেজ!',
    ...
    tags: ['ব্রেকিং', 'নিউজ', 'ভাইরাল_ভিডিও', 'বাংলাদেশ'],
    views: 521800,
    likes: 41200,
    shares: 28900,
    duration: '10:53',
    ...
    midrollTime: 7,
    adDuration: 20,
    directDownloadLink: 'https://example.com/download-clip',
    uploaderName: 'নিউজ এক্সপ্রেস',
    status: 'published'
  },
  {
    id: 'vid-3',
    title: '🎬 নতুন ভাইরাল রোমান্টিক নাটক স্পেশাল সিন - লাখো দর্শকের মন জয় করল',
    description: 'বছরের অন্যতম সেরা নাটকের সবচেয়ে আবেগঘন দৃশ্য। পুরো পর্ব দেখতে চোখ রাখুন!',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4',
    videoType: 'mp4',
    thumbnail: 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?w=800&auto=format&fit=crop&q=80',
    category: '🎬 নাটক ও মুভি',
    tags: ['নাটক', 'বাংলা_নাটক', 'রোমান্টিক', 'সিনেমা'],
    views: 189400,
    likes: 15300,
    shares: 5400,
    duration: '00:15',
    ...
    midrollTime: 7,
    adDuration: 20,
    directDownloadLink: 'https://example.com/watch-drama',
    uploaderName: 'বাংলা ড্রামা ওয়ার্ল্ড',
    status: 'published'
  },
  {
    id: 'vid-4',
    title: '📱 টিকটক ও ইনস্টাগ্রামে ঝড় তোলা ভাইরাল শর্টস রিলস ডান্স কালেকশন',
    description: 'লক্ষ লক্ষ ভিউ পাওয়া এই মুহূর্তের সেরা ট্রেন্ডিং ডান্স রিলস। না দেখলে মিস করবেন!',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4',
    videoType: 'mp4',
    thumbnail: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=800&auto=format&fit=crop&q=80',
    category: '📱 রিলস ও শর্টস',
    tags: ['রিলস', 'শর্টস', 'ডান্স', 'টিকটক'],
    views: 458900,
    likes: 67300,
    shares: 34100,
    duration: '00:15',
    ...
    midrollTime: 7,
    adDuration: 20,
    directDownloadLink: 'https://example.com/viral-reels',
    uploaderName: 'রিলস মাস্টার',
    status: 'published'
  },
  {
    id: 'vid-5',
    title: '🏏 শেষ ওভারে অবিশ্বাস্য নাটকীয়তা! ভাইরাল ক্রিকেট ম্যাচের শেষ মুহূর্তের দৃশ্য',
    description: 'শ্বাসরুদ্ধকর ম্যাচ ফিনিশিং! স্টেডিয়ামের দর্শক থেকে সোশ্যাল মিডিয়া সবাই হতবাক!',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4',
    videoType: 'mp4',
    thumbnail: 'https://images.unsplash.com/photo-1531415074968-036ba1b575da?w=800&auto=format&fit=crop&q=80',
    category: '🏏 খেলাধুলা',
    tags: ['ক্রিকেট', 'ম্যাচ', 'স্পোর্টস', 'হাইলাইটস'],
    views: 612400,
    likes: 89000,
    shares: 42000,
    duration: '01:00',
    ...
    midrollTime: 7,
    adDuration: 20,
    directDownloadLink: 'https://example.com/cricket-clip',
    uploaderName: 'স্পোর্টস বাংলা',
    status: 'published'
  },
  {
    id: 'vid-6',
    title: '🎵 গ্রামের ছেলেটির কণ্ঠে হৃদয়স্পর্শী গান শুনে সবাই কাঁদলো! ভাইরাল গান',
    description: 'অসাধারণ প্রতিভা! কোনো সুরের বাদ্যযন্ত্র ছাড়া এত সুন্দর গান আগে কখনো শুনেননি।',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyBlazes.mp4',
    videoType: 'mp4',
    thumbnail: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=800&auto=format&fit=crop&q=80',
    category: '🎵 ভাইরাল গান',
    tags: ['গান', 'মিউজিক', 'হৃদয়স্পর্শী', 'ভাইরাল'],
    views: 789200,
    likes: 112000,
    shares: 63000,
    duration: '00:15',
    ...
    midrollTime: 7,
    adDuration: 20,
    directDownloadLink: 'https://example.com/viral-song',
    uploaderName: 'সুরের ভুবন',
    status: 'published'
  }
];
...
export const INITIAL_SITE_SETTINGS: SiteSettings = {
  siteName: 'ভাইরাল ভিডিও দেখুন',
  siteTagline: 'দ্রুততম স্পিডে আনলিমিটেড ভাইরাল ভিডিও দেখুন',
  announcement: '🔥 আজকের সব নতুন ভাইরাল ভিডিও সবার আগে দেখতে আমাদের টেলিগ্রাম চ্যানেলে জয়েন করুন!',
  enableAnnouncement: true,
  telegramLink: 'https://t.me/viralvideobangla',
